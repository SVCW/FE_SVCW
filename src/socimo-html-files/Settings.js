                  ...
                  <div className="col-lg-3 mb-4">
                    <nav className="responsive-tab">
                      <ul className="nav nav-tabs uk-list">
                        ...
                        <li className="nav-item">
                          <a className href="#notification" data-toggle="tab">
                            Notification
                          </a>
                        </li>

                        <li className="nav-item">
                          <a className href="#billing" data-toggle="tab">
                            Billing and Payout
                          </a>
                        </li>

                        <li className="nav-item">
                          <a className href="#close" data-toggle="tab">
                            Close Account
                          </a>
                        </li>
                      </ul>
                      ...
                      <div className="tab-content" id="components-nav">
                        ...
                        <div className="tab-pane active fade show" id="account">
                          <div className="uk-width">
                            <div className="setting-card">
                              ...
                              <p className="mb-4">
                                This is your public presence on Socimo. You need
                                a account to upload your paid courses, comment
                                on courses, purchased by users, or earning.
                              </p>
                              <h6>Basic Profile</h6>
                                ...
                                <fieldset className="row merged-10">
                                  ...
                                  <div className="mb-4">
                                    <div className="social-links">
                                      ...
                                      />
                                      <em>
                                        Add your Facebook username (e.g.
                                        johndoe).
                                      </em>
                                    </div>
                                  </div>
                        ...
                        <div className="tab-pane fade" id="billing">
                          <div className="uk-width">
                            <div className="setting-card">
                              ...
                              <p className="mb-4">
                                Want to charge for a course? Provide your
                                payment info and opt in for our promotional
                                programs{" "}
                              </p>
                                    ...
                                    <div className="tab-content">
                                      ...
                                      >
                                        <div className="paypal-card">
                                          <p>
                                            After payment via PayPal's secure
                                            checkout, we will send you a link to
                                            download your files.
                                          </p>
                                          <form>
                                          ...
                                          <p>
                                            Paypal also accept the Payment
                                            Methods
                                          </p>
                                          <figure>
                                            <img
                                      ...
                                      >
                                        <div className="paypal-card">
                                          <p>
                                            After payment via bitcoin secure
                                            checkout, we will send you a link to
                                            download your files.
                                          </p>
                                          <form>
                                          ...
                                          <p>
                                            Bitcoin also accept the Payment
                                            Methods
                                          </p>
                                          <figure>
                                            <img
                                      ...
                                      <div className="tab-pane fade" id="swift">
                                        ...
                                        <p className="mt-3">
                                          ...
                                          PayPal transfer or even via bank
                                          account in just a few clicks. All you
                                          need is your email address or mobile
                                          number.{" "}
                                          <a title href="#">
                                            More about PayPal
                                          </a>{" "}
                        ...
                        <div className="tab-pane fade" id="close">
                          <div className="del-account">
                            <h2>Close Account</h2>
                            <p className="mb-4">
                              <b>Warning:</b> If you close your account, you
                              will be unsubscribed from all your followers and
                              friends, and will lose access forever.
                            </p>
                            <form method="post">
                              <div className="row">
                                <div className="mb-4 col-lg-6">
