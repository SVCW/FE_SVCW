                    ...
                    <div className="main-wraper">
                      <div className="feedback-form">
                        <h4 className="text-center">
                          <i className="icofont-comment" /> Send Feedback
                        </h4>
                        <form className="mt-4">
                              ...
                              <div className="feed-back-emojies">
                                ...
                                <ul>
                                  ...
                                  <li>
                                    <a href="#" title>
                                      <img
                                        src="images/smiles/quiet.png"
                                        alt=""
                                      />
                                    </a>
                                  </li>
                                  <li>
                                    <a className="selected" href="#" title>
                                      <img
                                        src="images/smiles/in-love.png"
                                        alt=""
                                      />
                                    </a>
                                  </li>
